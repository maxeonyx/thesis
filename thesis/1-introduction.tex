...
Transformer models are quickly taking over the field of deep learning, due to their flexibility and proven usefulness. Code completion, image classification, generative art, and many other tasks are being sucessfully tackled with transformer models.
...
\begin{enumerate}
    \item \Cref{C:background} \nameCref{C:background} introduces notation and concepts for neural networks which will be used throughout.
