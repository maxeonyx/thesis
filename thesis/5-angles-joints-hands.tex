...
In \Cref{C:background} I introduced some loss functions such as the Mean Squared Error (MSE), which predicts the posterior expectation $\mathbb{E}(y | x)$. In this section I will discuss some training objectives that are used for learning data which sits on the unit circle $^1$.
