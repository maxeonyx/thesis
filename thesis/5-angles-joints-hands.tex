...
\subsection{Heirarchy of Rotations}
...
The analogous loss functions to the mean squared error for data that sits on the unit circle is the \textit{angular} mean-squared-error, which will be used later on in \Cref{C:hand-model}. It is defined as follows:
...
The von-Mises distribution (eg. \cite{von-mises}) is a distribution over angles on the unit circle. It is defined as follows:
\newcommand{\vm}{\text{vM}}
\begin{align}
\label{eqn:von-mises}
\begin{aligned}
