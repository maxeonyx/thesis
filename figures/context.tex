\resizebox{\linewidth}{!}{\begin{tikzpicture}
    ...
    \node (deconly) at (2.5cm, 0.5) { \textbf{\Cref{ss:decoder-only}} \\ Decoder-only \\ transformers. };
    \node[right of=deconly] (autoregpre) { \textbf{\Cref{ss:autoreg-pretraining}} \\ Autoregressive pretraining. };
