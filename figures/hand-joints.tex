...
\begin{tikzpicture}
    \begin{pgfonlayer}{img}
        \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=17cm]{hand-compressed.png}};
    \end{pgfonlayer}
    \begin{scope}[x={(image.south east)},y={(image.north west)}]
        ...
        \node[marker] (wrist_mark) at (0.32,0.47) {};
        ...
        \node[marker,save path=\thumpmcpmark] (thumb_mcp_mark) at (0.52,0.22) {};
        ...
        \node[marker] (thumb_cmc_mark) at (0.41,0.29) {};
        ...
        \node[marker] (thumb_ip_mark) at (0.63,0.24) {};
        ...
        \node[marker] (index_mcp_mark) at (0.62,0.48) {};
        ...
        \node[marker,save path=\indexpipmark] (index_pip_mark) at (0.72,0.5) {};
        ...
        \node[marker,save path=\indexdipmark] (index_dip_mark) at (0.77,0.5) {};
        ...
        \node[marker,save path=\midmcpmark] (mid_mcp_mark) at (0.58,0.62) {};
        \node[label] (mid_mcp_text) at (0.85, 0.005+0.065*6) {Middle MCP (2 df.)};
        \begin{pgfonlayer}{bg}
        ...
        \node[marker,save path=\middipmark] (mid_dip_mark) at (0.76,0.64) {};
        \node[label] (mid_dip_text) at (0.85, 0.005+0.065*8) {Middle DIP (1 df.)};
        \begin{pgfonlayer}{bg}
        ...
        \node[marker,save path=\ringmcpmark] (ring_mcp_mark) at (0.56, 0.68) {};
        \node[label] (ring_mcp_text) at (0.85, 0.005+0.065*9) {Ring MCP (2 df.)};
        \draw[-] (ring_mcp_text.south west) -- (ring_mcp_text.south east);

        \node[marker,save path=\midpipmark] (mid_pip_mark) at (0.69,0.64) {};
        \node[label] (mid_pip_text) at (0.85, 0.005+0.065*7) {Middle PIP (1 df.)};
        \begin{pgfonlayer}{bg}
        ...
        \node[marker, save path=\ringdipmark] (ring_dip_mark) at (0.71, 0.75) {};
        \node[label] (ring_dip_text) at (0.85, 0.005+0.065*11) {Ring DIP (1 df.)};
        \begin{pgfonlayer}{bg}
            \draw[-] (ring_dip_mark) -- (ring_dip_text.south west);
        \end{pgfonlayer}
        \draw[-] (ring_dip_text.south west) -- (ring_dip_text.south east);

        \node[marker,save path=\ringpipmark] (ring_pip_mark) at (0.64, 0.74) {};
        \node[label] (ring_pip_text) at (0.85, 0.005+0.065*10) {Ring PIP (1 df.)};
        \begin{pgfonlayer}{bg}
        ...
        \node[marker,save path=\pinkypipmark] (pinky_pip_mark) at (0.57, 0.82) {};
        \clip[use path=\pinkypipmark,reverseclip];
        \node[marker,save path=\pinkydipmark] (pinky_dip_mark) at (0.62, 0.86) {};
        ...
        \node[marker] (pinky_mcp_mark) at (0.51, 0.75) {};
